...
public class PlatformGenerator : MonoBehaviour {
	...
	public ScoreManager theHighscore;
	...
	void Start () {
		...
		theHighscore = FindObjectOfType<ScoreManager>();
	...
	void Update () {
		...
		if(transform.position.x < generationPoint.position.x)
		{
			...
			if((theScore.scoreCount >= (theHighscore.highscoreCount/3)) && theHighscore.highscoreCount > 3000)
			{	
			...
			if((theScore.scoreCount >= (theHighscore.highscoreCount / 2)) && theHighscore.highscoreCount > 5000)
			{
				Debug.Log("Generating spikes...");
